...
class SearchPageLocators:
    ...
    MEN_BOTTOM_BAR = (AppiumBy.XPATH, "//*[@text='MEN' or contains(@text,'MEN')]")
    ...
    # First visible product (top-left of grid, no ratings) — above MEN/SORT bar
    FIRST_PRODUCT_LEFT_TOP = (AppiumBy.XPATH, "(//androidx.recyclerview.widget.RecyclerView)[2]//android.view.ViewGroup[.//android.widget.ImageView][1]")
    FIRST_PRODUCT_LEFT_TOP_ALT = (AppiumBy.XPATH, "(//androidx.recyclerview.widget.RecyclerView)[2]//android.view.ViewGroup[.//android.widget.ImageView][2]")
